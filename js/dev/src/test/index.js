...
<div id="dinglj-main">
    <div v-if="inited">
        <div v-for="v_ticket in runtime.rt.tickets">
            <span style="display: inline-block; margin: 0 10px;" v-for="v_field in Object.values(v_ticket)">
                {{ v_field }}
            </span>
        </div>
    </div>
...
createApp({
    setup() {
        ...
        return {
            runtime, inited,
            loadRptData_004, readTickets_004
        }
    }
}).mount('#dinglj-main');
